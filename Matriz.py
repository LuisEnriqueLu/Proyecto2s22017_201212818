...
class Matriz():
    ...
    def verMes(self, fecha):
        if fecha == "01" or fecha == "1":
            return "Enero" 
        elif fecha == "02" or fecha == "2":
            return "Febrero"
        elif fecha == "03" or fecha == "3":
            return "Marzo"
        elif fecha == "04" or fecha == "4":
            return "Abril"
        elif fecha == "05" or fecha == "5":
            return "Mayo"
        elif fecha == "06" or fecha == "6":
            return "Junio"
        elif fecha == "07" or fecha == "7":
            return "Julio"
        elif fecha == "08" or fecha == "8":
            return "Agosto"
        elif fecha == "09" or fecha == "9":
            return "Septriembre"  
        elif fecha == "10":
            return "Octubre"
        elif fecha == "11":
    ...
    def ArchivoMatriz(self):
        ...
        outfile = open("C:\\Users\\l_enr\\Desktop\\Matriz.txt", 'w')
        temp=self.inicioMes
        while temp!=None:
            ident=""
