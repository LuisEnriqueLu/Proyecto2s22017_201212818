...
if __name__ == "__main__":    
    ...
    while nwhile!=None:
        ...
        if num == "1":
            ...
            claseArbolB.crearNodoInsertar(97, "A", "2", "1", "3", 456, "si")
            claseArbolB.crearNodoInsertar(98, "b", "2", "1", "3", 132, "si")
            claseArbolB.crearNodoInsertar(99, "c", "2", "1", "3", 562, "si")
            claseArbolB.crearNodoInsertar(102, "A", "2", "1", "3", 789, "si")
            claseArbolB.crearNodoInsertar(122, "z", "2", "1", "3", 46, "si")
            claseArbolB.crearNodoInsertar(150, "A", "2", "1", "3", 10, "si")
            claseArbolB.crearNodoInsertar(65, "z", "2", "1", "3", 4568, "si")
            claseArbolB.crearNodoInsertar(82, "z", "2", "1", "3", 1230, "si")
